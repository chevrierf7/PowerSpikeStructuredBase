...
const COURT_VISUAL_SURFACE_TOP_Y := 0.025
...
const FLOOR_Y := 0.12
const CHARACTER_GROUND_Y := 0.08
const PLAYER_VISUAL_FOOT_CORRECTION := 0.075
...
const PLAYER_AVATAR_SCENE := "res://characters/player/anime_model_boy_rigged_animated.glb"
